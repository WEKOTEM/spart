...
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_,"✳️~ >>"..keko_text[keko3].."\n🖼~ >> عدد صورك ~⪼ "..all_photo_tshake.."\n🔗~ >> ايديك » ("..msg.sender_user_id_..")\n©~ >> معرفك » "..keko_info.."\n🔰~ >>موقعك » "..t.."\n🔖~ >> رسائلك » {"..user_msgs.."}\n😪~ >> السحكات ~ >> {"..edit.."}\n✶⊶⊷⊶⊷⊶⊷★⊶⊷⊶⊷⊶⊷✶ ",msg.id_,msg.id_.."")
else 
...
🔽┇<a href="https://t.me/TH3TG/3">لتنصـيب سـورسـ تآجي ع آلتوگن</a> 
